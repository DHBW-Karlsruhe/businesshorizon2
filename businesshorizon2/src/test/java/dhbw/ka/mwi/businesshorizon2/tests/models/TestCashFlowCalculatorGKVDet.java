 ...
 * dar. Entspricht letztendlich dem Testfall "TestCashFlowCalculatorGKVSto";
...
public class TestCashFlowCalculatorGKVDet extends TestCase{
	private static final Logger logger = Logger
			.getLogger("TestCashFlowCalculatorGKVDet.class");

	@Test
	public void testCashFlowCalculatorGKVDet() {
