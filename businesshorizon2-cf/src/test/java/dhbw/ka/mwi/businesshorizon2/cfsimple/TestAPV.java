...
public class TestAPV {
    ...
    public void testAPVYannik() throws Exception {
        ...
        assertEquals(-48779385984d,new APV().calculateUWert(parameter),48779385984d / 10000);
    }
    ...
    public void testAPVBallwieser() throws Exception {
        ...
        assertEquals(1055.24,new APV().calculateUWert(parameter),1055.24 / 10000);
    }
    ...
    public void testFCFPohl() throws Exception {
        ...
        assertEquals(1569.19,new APV().calculateUWert(parameter),1569.19 / 10000);
    }
}
