...
public class TestAPV {
    ...
    public void testAPVYannik() throws Exception {
        final CFEntityParameter parameter = new CFEntityParameter(new double[]{3960000000d,4158000000d,4365900000d,4584195000d,4813404750d,5054074987.5d,5054074987.5d},new double[]{162542000000d,177170780000d,193116150200d,210496603718d,229441298053d,250091014877d,250091014877d},0.1,0.26325,0.01);
    ...
    public void testAPVBallwieser() throws Exception {
        ...
        assertEquals(1055.24,new APV().calculateUWert(parameter),0.1);
    }
    ...
    public void testFCFPohl() throws Exception {
        ...
        assertEquals(1569.19,new APV().calculateUWert(parameter),0.1);
    }
}
